...
import { BindingApi, BindingParams, ButtonApi, FolderApi, FolderParams } from '@tweakpane/core';
...
declare class SymbolPropertiesUBO {
	...
	static readonly EVAL_FLAT_SIZES: readonly number[];
...
declare class SymbolPropertyBinderUBO {
	 ...
	 *   zoom-dep → [min, max]
	 */
	evaluateAllProperties(feature: Feature, featureState: FeatureState, canonical: CanonicalTileID, availableImages: ImageId[], brightness?: number | null, formattedSection?: FormattedSection, activeAppearance?: SymbolAppearance | null): Float32Array;
	/**
...
export declare class RasterTileSource<T = "raster"> extends Evented<SourceEvents> implements ISource<T> {
	...
	hasTile(tileID: OverscaledTileID): boolean;
	loadTile(tile: Tile, callback: Callback<undefined>): void;
	loadTileWithProvider(tile: Tile, provider: TileProvider<ArrayBuffer>, request: RequestParameters, controller: AbortController, callback: Callback<undefined>): Promise<void>;
	abortTile(tile: Tile, callback?: Callback<undefined>): void;
	unloadTile(tile: Tile, callback?: Callback<undefined>): void;
	hasTransition(): boolean;
...
type LineDefinesType = "RENDER_LINE_GRADIENT" | "RENDER_LINE_DASH" | "RENDER_LINE_TRIM_OFFSET" | "RENDER_LINE_BORDER" | "LINE_JOIN_NONE" | "ELEVATED" | "ELEVATED_ROADS" | "VARIABLE_LINE_WIDTH" | "CROSS_SLOPE_VERTICAL" | "CROSS_SLOPE_HORIZONTAL" | "ELEVATION_REFERENCE_SEA" | "ELEVATION_GROUND_SCALE" | "LINE_PATTERN_TRANSITION" | "USE_MRT1" | "DUAL_SOURCE_BLENDING" | "LINE_BLEND_MULTIPLY" | "DEBUG_ELEVATION_ID";
...
type DevToolsFolder = {
	addBinding: <T extends object>(target: T, key: keyof T, params?: BindingParams, callback?: Callback$1) => void;
...
declare class DevTools implements IControl {
	_map: Map$1;
	_pane: Pane;
	...
	_onReset(): void;
	_onToggleFold(): void;
	_addParameter<T extends object>(folder: FolderApi, target: T, key: keyof T, params?: BindingParams, callback?: Callback$1): void;
...
type CoreStyleLayer = BackgroundStyleLayer | CircleStyleLayer | CustomStyleLayer | FillExtrusionStyleLayer | FillStyleLayer | HeatmapStyleLayer | HillshadeStyleLayer | LineStyleLayer | ModelStyleLayer | RasterStyleLayer | SkyLayer$1 | SymbolStyleLayer;
type HDStyleLayer = BuildingStyleLayer | RasterParticleStyleLayer;
type TypedStyleLayer = CoreStyleLayer | HDStyleLayer | FeaturelessStyleLayer;
