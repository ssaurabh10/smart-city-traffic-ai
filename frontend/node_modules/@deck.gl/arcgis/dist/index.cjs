...
function render(resources, viewport) {
  ...
  if (device instanceof import_webgl.WebGLDevice) {
    ...
    let screenFbo = null;
    if (externalFbo) {
      if (((_a = resources._externalFramebuffer) == null ? void 0 : _a.handle) !== externalFbo) {
        (_b = resources._externalFramebuffer) == null ? void 0 : _b.wrapper.destroy();
...
function finalizeResources(resources) {
  ...
  (_a = resources._externalFramebuffer) == null ? void 0 : _a.wrapper.destroy();
}
